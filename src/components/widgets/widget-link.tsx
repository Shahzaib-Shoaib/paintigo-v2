  ...
  return (
    ...
    >
      {!data?.isCompanyIntroduction ? (
        <>
          <h4 className="text-black text-sm md:text-base xl:text-lg font-semibold mb-5 2xl:mb-6 3xl:mb-7">
            {t(`${widgetTitle}`)}
          </h4>
          <ul className="text-sm lg:text-sm text-black flex flex-col space-y-3 lg:space-y-3.5">
            {lists.map((list) => (
              <li
        ...
        <div className="me-4 flex flex-col space-y-7 lg:space-y-7.5">
          <Logo className="" />
          <p className="text-sm font-normal text-black leading-6 max-w-[334px] ">
            {description}
          </p>
