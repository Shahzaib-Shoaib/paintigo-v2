    ...
    >
      ...
      >
        ...
        <div>
          ...
          {type === 'modern' && <span className="text-base text-[#5A5A5A] font-normal">Posted on Amazon</span>}
        </div>

        {type == 'modern' ? (
          <div className="inline-grid grid-cols-5 gap-1.5 mt-3 lg:mt-5 ml-4">
      ...
      <Text
        className={cn('text-sm sm:leading-7 lg:text-base lg:leading-[1.625rem] mt-5 xl:mt-7 text-[#5A5A5A]', {
